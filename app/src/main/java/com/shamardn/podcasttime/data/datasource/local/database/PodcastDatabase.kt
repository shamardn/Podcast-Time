...
@Database(
    entities = [PodcastEntity::class, EpisodeEntity::class, SubscriptionsEntity::class, RecentEntity::class, ArtistEntity::class, EpisodeDownloadEntity::class, PlaylistEntity::class],
    version = 1,
    exportSchema = true,
)
